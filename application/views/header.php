...
<body>
	<div>
		...
		<li><a href='<?php echo site_url('main/agents')?>'>Agents</a></li>
		<li><a href='<?php echo site_url('main/bands')?>'>Bands</a></li>
		<li><a href='<?php echo site_url('main/members')?>'>Members</a></li>
		<li><a href='<?php echo site_url('main/stages')?>'>Stages</a></li>
		<li><a href='<?php echo site_url('main/perfmanagement')?>'>Performances</a></li>
		<li><a href='<?php echo site_url('main/timeslots')?>'>Time Slots</a></li>
			<ul id="rightnav">
